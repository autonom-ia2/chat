...
- gotchas: nada e disparado aqui, a selecao vira uma lista e uma etiqueta de segmento nos contatos, e a campanha le essa etiqueta quando envia; entram so leads prontos para campanha, com telefone e WhatsApp verificado e sem bloqueio no contato; ficam de fora, com o motivo no resumo, descartado, contato bloqueado, sem telefone, sem WhatsApp verificado e ainda nao pronto; as campanhas de envio unico ativas aparecem primeiro, depois as da API do WhatsApp agendadas; vao ate 500 leads por vez; nome de segmento igual a etiqueta que ja existe e recusado; descartar um lead depois tira a etiqueta do contato dele, e campanha agendada ou de envio unico que ainda nao disparou deixa de alcanca-lo; limitacao: campanha da API do WhatsApp que ja comecou a enviar continua mandando aos destinatarios pendentes, mesmo depois do descarte.
- nav_target: `autonomia_prospecting_search`
<!-- RECUSA #713/#737: completar -->
