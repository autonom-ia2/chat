    ...
    wrapper = mount(Dashboard, {
      global: {
        ...
        stubs: {
          ...
          // Fork-only children that read the Vuex store; the spec mounts
          // without one, so they are stubbed like the upstream launchers.
          AutonomiaGuideLauncher: true,
          AutonomiaCopilotContainer: true,
          AutonomiaGuideContainer: true,
          GuideHighlight: true,
          CrmFollowUpReminderModal: true,
          EmailCampaignAiToast: true,
        },
      },
    });
    await flushPromises();
