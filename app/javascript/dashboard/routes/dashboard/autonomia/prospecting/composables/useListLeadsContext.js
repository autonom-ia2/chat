...
export const useListLeadsContext = ({
  ...
  const context = {
    canManage,
    settings,
    // Enviar ao CRM pela mesma regra do servidor (Crm::CardPolicy#create?),
    // como na busca: vale para o card, o painel e o envio da lista.
    canSendToCrm: computed(() => canSendToCrm(canManage.value, settings.value)),
