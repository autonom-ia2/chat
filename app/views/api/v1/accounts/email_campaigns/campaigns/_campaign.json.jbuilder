...
json.last_error EmailCampaigns::Presentation::Errors.campaign_code(campaign.last_error)
...
json.recipient_import EmailCampaigns::Presentation::ImportSummary.new(campaign).campaign_status
json.merge! campaign_presentation(campaign)
