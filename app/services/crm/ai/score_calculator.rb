module Crm
  module Ai
    # Converte os SINAIS que a IA leu da conversa em um NÚMERO de 0 a 100.
    #
    # Por que o número não vem do modelo: pedir "dê uma nota de 0 a 100" produz 70 hoje e 85 amanhã
    # para a mesma conversa. Nota instável = o time deixa de olhar. A IA classifica sinais (que ela
    # faz bem, com evidência); o peso de cada sinal e o decaimento por tempo ficam aqui, versionados,
    # ajustáveis sem tocar em prompt.
    #
    # O score responde "o quanto isso precisa de atenção humana agora" e serve a qualquer tipo de
    # funil: a escada é o próprio funil (distância até o PRÓXIMO estágio, nunca encaixe no atual —
    # senão o auto-move pontuaria a própria decisão que acabou de tomar).
