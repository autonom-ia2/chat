...
module Autonomia::Agents::Tools::Native::InsuranceQuote::Declaracao
  ...
  COMUNS = [
    ...
    { 'name' => 'item', 'type' => 'string',
      'description' => 'Nome curto do bem desta cotação, como o cliente o reconhece: o carro pelo modelo e placa, o ' \
                       'imóvel pelo que o distingue. Para recotar ou corrigir um bem que já tem cotação nesta ' \
                       'conversa, repita exatamente o nome que ele já tem; bem diferente, nome novo. Dois bens são ' \
                       'duas chamadas, cada uma com o seu nome.' },
