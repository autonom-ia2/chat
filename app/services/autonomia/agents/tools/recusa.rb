...
module Autonomia::Agents::Tools::Recusa
  ...
  MOTIVOS = {
    ...
    # Fatia 2 do #420: a ferramenta da Lia respondeu no turno porque não havia preço a publicar.
    'resultado_respondido_no_turno' => 'a consulta ao resultado da cotação respondeu ao modelo no turno, sem preço a publicar; ' \
                                       'nenhuma execução foi aberta',
