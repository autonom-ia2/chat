module Autonomia
  module Agents
    module Knowledge
      # IA Revisora de Qualidade do Conhecimento (gpt-5.6-sol, structured output via ResponsesClient).
      ...
      class Reviewer
        ...
        # parâmetro `temperature` (o gpt-5.6-sol o rejeita). A estabilidade da nota vem da RUBRICA explícita
