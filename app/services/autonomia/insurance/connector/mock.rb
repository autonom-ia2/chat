...
class Autonomia::Insurance::Connector::Mock < Autonomia::Insurance::Connector::Client
  ...
  # Regenerado em 25/09/2026 na branch `feat/renovacao-residencial-empresarial` (adapters, commit 5ffa0eb), com o
  # grupo `renovacao` (seguradora anterior, bônus, sinistros, número da apólice e fim da vigência), pelo mesmo
  # comando do de empresarial abaixo, com '2' no lugar de '18'.
  ...
  # `feat/renovacao-residencial-empresarial` (adapters, commit 5ffa0eb), que soma o grupo `renovacao` aos dez campos
