...
RSpec.describe Autonomia::Prospecting::Research::Registry::ParserSupport, '.phones' do
  ...
  it 'grava os telefones no perfil da empresa' do
    payload = fixture('brasilapi-success').merge('ddd_telefone_1' => '4230351935')

    expect(parse('BrasilApiParser', payload).profile_attributes['data']).to include('phones' => ['554230351935'])
  end
