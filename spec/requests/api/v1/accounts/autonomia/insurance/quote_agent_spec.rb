...
RSpec.describe 'Autonomia Insurance Quote Agent API', type: :request do
  ...
  describe 'POST' do
    ...
    it 'cria o agente pronto, com o especialista' do
      ...
      # Auto, residencial e empresarial nascem juntos (chat#323, #654); fora de auto, o especialista só atende
      # onde a conexão tem o ramo.
      expect(agente.specialists.pluck(:slug)).to eq(%w[cotacao_auto cotacao_residencial cotacao_empresarial])
