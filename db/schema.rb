...
ActiveRecord::Schema[7.2].define(version: 2026_09_26_170000) do
  ...
  create_table "autonomia_prospecting_scoring_profile_accounts", force: :cascade do |t|
    t.bigint "scoring_profile_id", null: false
    t.bigint "account_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["account_id"], name: "idx_autonomia_prospecting_scoring_profile_accounts_account"
    t.index ["scoring_profile_id", "account_id"], name: "idx_autonomia_prospecting_scoring_profile_accounts_unique", unique: true
  end
  ...
  create_table "autonomia_prospecting_searches", force: :cascade do |t|
    ...
    t.string "area_type", default: "radius", null: false
    t.jsonb "area_config", default: {}, null: false
    t.jsonb "categories", default: [], null: false
    t.jsonb "metadata", default: {}, null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["account_id", "area_type"], name: "idx_autonomia_prospecting_searches_acc_area"
  ...
  create_table "autonomia_prospecting_settings", force: :cascade do |t|
    ...
    t.string "google_maps_browser_api_key"
    t.jsonb "metadata", default: {}, null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.bigint "default_crm_pipeline_id"
    t.bigint "default_crm_stage_id"
    t.string "scoring_mode", default: "profile", null: false
    t.bigint "scoring_profile_id"
    t.jsonb "custom_scoring_weights", default: {}, null: false
